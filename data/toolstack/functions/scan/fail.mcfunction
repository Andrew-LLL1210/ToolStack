...
execute if score @s toolmode matches 1 if block ~ ~ ~ #toolstack:tillable run scoreboard players set @s specialtool 4
execute if score @s toolmode matches 1 if score @s tool matches 1 if block ~ ~ ~ #toolstack:waxed run scoreboard players set @s specialtool 2
